			...
			<header className="navbar bg-base-300 ">
				<div className="flex justify-between  w-full">
					...
					<div className="flex gap-2 sm:gap-5">
						...
						<Link href={'/product'} className='btn btn-outline btn-sm'>Login</Link>
					</div>
				</div>
			</header>
			<main className='container px-5'>
				...
				<section className="py-5 text-center">
					<div className="flex flex-col gap-5">
						...
						<p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
							Savor the perfect blend of tofu and meatballs in every bite. Authentic Indonesian street food, now at your fingertips.
						</p>
					</div>
				...
				<section id="about" className="mt-20">
					...
					<p className="mt-4 max-w-[700px] md:text-xl ">
						Tahu Bakso is a beloved Indonesian street food that combines the goodness of tofu with the savory taste of meatballs.
						Our recipe has been perfected over generations, bringing you an authentic taste of Indonesia's culinary heritage.
					</p>
				</section>
					...
					<div className="card-body   ">
						...
						<div className="grid grid-cols-1 space-y-2">
							{[
								...
								{ name: 'Michael R.', text: 'I love the variety of flavors. The spicy version is my favorite!' },
								{ name: 'Andi S.', text: 'Reminds me of home. Thank you for bringing this taste to our city.' }
							]
				...
				<section id="contact" className="card card-compact">
					<div className="card-body ">
						...
						<form className="grid grid-cols-1 space-y-2">
							...
							<button type="submit"
								className="w-full btn btn-outline">Send Message</button>
						</form>
					</div>
				</section>
			</main>
				...
				<div className="container px-4 md:px-6">
					...
					<div className="flex flex-col items-center justify-between gap-4 md:flex-row">
						...
						<nav className="flex gap-4">
							<a className="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300" href="#">
								Privacy Policy
							</a>
							<a className="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300" href="#">
								Terms of Service
