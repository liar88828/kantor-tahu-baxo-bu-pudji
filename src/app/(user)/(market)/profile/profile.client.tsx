...
export function ProfileServer() {
    ...
    const loadEmpty = invoices.data.length === 0 &&
			<div className={ 'flex justify-center' }><PageEmptyData page={ 'Order Profile' }/></div>
    const loadData = invoices.data.map((invoice) => (
        <div
            key={ invoice.id }
...
export function ChangeProfile({ user }: ChangeProfileProps) {
