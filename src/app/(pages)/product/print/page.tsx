...
export default async function Page() {
	...
	const { data } = await useFetch<TProduct[]>("GET", 'product', {})
	const { data: dataTravel } = await useFetch<TDelivery[]>("GET", 'delivery', {})
	const { data: dataBank } = await useFetch<TPaymentDB[]>("GET", 'payment', {})
