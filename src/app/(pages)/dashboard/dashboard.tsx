...
const chart = async () => await fetch('http://localhost:3000/api',
	{ cache: 'no-store' })
	.then(data => data.json())

const notify = async () => await fetch('http://localhost:3000/api',
	{ cache: 'no-store' })
	.then(data => data.json())

const pesanan = async (status: string) => await fetch(`http://localhost:3000/api`
	, { cache: 'no-store' })
	.then(data => data.json())
