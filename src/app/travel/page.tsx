...
}                                                               from '@/app/components/travel/format';
import {
  handleUpload, SendData, UploadDescription
}                                                               from '@/app/elements/upload/UploadDescription';

// const WithCustomLoading = dynamic( () =>
// import('../../element/UploadDescription').then( Element =>
// Element.UploadDescription ) )

export default function Home() {
  const { control, register, handleSubmit, } = useForm<TTravel>( {/* defaultValues: defaultValues, */
    mode: "onChange",
  } );
  ...
  const onSubmit: SubmitHandler<TTravel> = ( data ) => {
    handleUpload(
      selectedFile,
