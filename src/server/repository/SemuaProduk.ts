...
// import type { IRepoSemuaProduce } from '@/interface/repository/SemuaProduk';
...
//
// export default class RepoSemuaProduk extends ARepository<"semuaProduct"> implements IRepoSemuaProduce<TYPE> {
