...
import { TReceiverCreate, TReceiverDB } from "@/lib/validation/receiver.valid";

export type TOrderProductDB = OrderProduct
export type TOrderProductCreate = Omit<OrderProduct, 'id' | "created_at" | "updated_at" | 'id_order'>;
